...
public class accountdata_Activity extends AppCompatActivity {
        ...
        if (currentUser != null) {
            ...
            mDatabase.child("Users").child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(accountdata_Activity.this, "Failed to load user data.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
            ...
            currentUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(accountdata_Activity.this, "Authentication failed. Please check your password.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
            ...
            mDatabase.child("Users").child(userId).updateChildren(userUpdates)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(accountdata_Activity.this, "User data updated successfully.", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(accountdata_Activity.this, "Failed to update user data.", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
    ...
    public void openHome(View view) {
        startActivity(new Intent(accountdata_Activity.this, MainActivity.class));
        finish();
    }

    public void openCart(View view) {
        startActivity(new Intent(accountdata_Activity.this, CartActivity.class));
        finish();
    }

    public void openFavorites(View view) {
        startActivity(new Intent(accountdata_Activity.this, FavoritesActivity.class));
        finish();
    }

    public void openWallet(View view) {
        startActivity(new Intent(accountdata_Activity.this, CarteiraActivity.class));
        finish();
    }

    public void openProfile(View view) {
        startActivity(new Intent(accountdata_Activity.this, ProfileActivity.class));
        finish();
    }

    public void openSettings(View view) {
        startActivity(new Intent(accountdata_Activity.this, SettingsActivity.class));
        finish();
    }
}
